...
import { Code2, Files, Settings2, Terminal as TerminalIcon } from "lucide-react";
...
export function RightPanel({ box, onRefresh }: { box?: BoxRecord; onRefresh: () => void }) {
  const [tab, setTab] = useState<"terminal" | "files" | "pi" | "code">("terminal");
  const boxId = box?.id;
